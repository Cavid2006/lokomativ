...
$(function() {
  changeMode('loading');
  var gets = [];
  gets.push(loadImage('https://res.cloudinary.com/stt/image/upload/v1450205193/VH01p4n_ictdef.jpg','board'));
  gets.push(loadImage('https://res.cloudinary.com/stt/image/upload/v1450205193/SQBvzMJ_umckwm.jpg','cards'));
  gets.push(loadImage('https://res.cloudinary.com/stt/image/upload/v1450205193/OTAcyyH_ls7prp.jpg','treasure'));
